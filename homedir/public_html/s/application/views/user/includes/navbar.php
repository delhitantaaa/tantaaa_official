<body>
	...
	<div class="main-wrapper">
		<header class="header sticktop" style="background-color:#030819;">
			<nav class="navbar navbar-expand-lg header-nav">
				...
				<div class="main-menu-wrapper">
					...
					<ul class="main-nav">
						...
						<li class="has-submenu">
							...
							?>
							<a href="<?php echo base_url();?>all-categories">All Services<i class="fas fa-chevron-down"></i></a>
							<ul class="submenu">
								<?php foreach ($result as $res) { ?>
								<li><a style="margin-left:10px;color:#2d3b48;" href="<?php echo base_url();?>search/<?php echo str_replace(' ', '-',strtolower($res['category_name']));?>"><?php echo ucfirst($res['category_name']);?></a></li>
								<?php } ?>
							</ul>
						</li>
						...
						<li><a href="javascript:void(0);" data-toggle="modal" data-target="#modal-wizard">Become a Partner</a></li>
						<!--<li><a href="javascript:void(0);" data-toggle="modal" data-target="#modal-wizard1">Register</a></li>-->
						<li class="login-link">
				...
				<ul class="nav header-navbar-rht" style="margin-right:30px;">
					<li class="nav-item" ><a href="javascript:void(0);" data-toggle="modal" data-target="#modal-wizard1" style="color:#939393;">Register</a></li>
					<?php 
					if($this->session->userdata('id') == '') { ?>
						<li class="nav-item">
							<a href="javascript:void(0);" data-toggle="modal" data-target="#tab_login_modal" style="color:#939393;">Login</a>
						</li>
					<?php }
					$wallet=0;
					$token='';
