				...
				<div class="row justify-content-center">
					<div class="col-lg-12">
						<div class="section-search">
							<h3>Home services, <span>on demand </span></h3>
							<p>Hygienic &amp; single-use products |  <?php echo $services_count?> low-contact services </p>
								...
								<form action="<?php echo base_url();?>search" id="search_service" method="post">
									...
									<div class="search-input line">
										...
										<div class="form-group mb-0">
											<input type="text" class="form-control common_search" name="common_search" id="search-blk" placeholder="Search for a service e.g.Plumber" >
										</div>
									</div>
