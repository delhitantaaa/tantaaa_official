                ...
                <div class="col-5 text-right d-none d-lg-block">
                    ...
                    <ul class="inline-links">
                        ...
                        <li>
                            ...
                            <a href="{{ route('orders.track') }}" class="top-bar-item">{{__('Order Tracking')}}</a>
                        </li>
                        ...
                        <li>
                            <a href="{{ route('user.registration') }}" class="top-bar-item">{{__('Sign Up')}}</a>
                        </li>
                        @endauth
                    </ul>
                </div>
                ...
                <div class="side-menu-header ">
                    ...
                    @else
                        ...
                        <div class="side-login px-3 pb-3">
                            ...
                            <a href="{{ route('user.registration') }}">{{__('Sign Up')}}</a>
                        </div>
                    @endauth
                </div>
                    ...
                    <div class="col-lg-9 col-4 position-static">
                        <div class="d-flex w-100">
                            <div class="search-box flex-grow-1 px-4">
                                <form action="{{ route('search') }}" method="GET">
                                    <div class="d-flex position-relative">
                                        ...
                                        <div class="w-100">
                                            <input type="text" aria-label="Search" id="search" name="q" class="w-100" placeholder="{{__('Search by products,category or collection')}}" autocomplete="off">
                                        </div>
                            ...
                            <div class="logo-bar-icons d-inline-block ml-auto">
                                ...
                                <div class="d-none d-lg-inline-block">
                                    <div class="nav-wishlist-box" id="wishlist">
                                        <a href="https://s.tantaaa.com/"target="_blank" class="nav-box-link">
                                            <span class="nav-box-text d-none d-xl-inline-block">{{__('Services')}}</span>
                                        </a>
                                    </div>
                                </div>
                            </div>
